...
def impact_of_single_academics_on_mental_health(include, desc, other_include=None):    
    ...
    make_barplot("Impact_on_mental_health_continuum", "(comp)"+desc+res_str_comp, True, -2, 2, comp_plot_dict, ylabels, True)
    make_barplot("Impact_on_mental_health_continuum", desc, True, -2, 2, plot_dict, ylabels, True, xlabels=['Q1','Q2','Q3','Q4','Q5','Q6','Q7','Q8','Q9','Q10'])
    make_barplot("Impact_on_mental_health_continuum", "not_" + desc, True, -2, 2, comp_plot_dict, ylabels, True, xlabels=['Q1','Q2','Q3','Q4','Q5','Q6','Q7','Q8','Q9','Q10'])
...
def mean_impact_of_all_academics_on_health(include, desc, other_include=None):
    ...
    res_str = "("+str(included_respondents)+" of "+str(all_respondents)+")"
    res_str_comp = "("+str(included_respondents_comp)+" of "+str(all_respondents)+")"    
    make_boxplot("Academic_impact_score_on_mental_health_continuum"+res_str, desc, True, -2, +2, ["impact score"], [academic_impacts])
    make_boxplot("Academic_impact_score_on_mental_health_continuum"+res_str_comp, "(comp)"+desc, True, -2, +2, ["impact score"], [comp_academic_impacts])
...
def ae0_and_ae1(include, desc, other_include=None):
    ...
    print("Questions AE0(SQ001)-AE0(SQ006) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
    print(get_possible_answers('AE0(SQ001)')[0:5])
    print("Questions AE1(SQ001)-AE1(SQ005) are scored on a scale from -3-3 representing numerical values assigned to the possible answers.")
    ...
    make_barplot("Social_perception", desc, True, 0, 4, data_dict_ae0, ylabels, xlabels=['Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6'])
    ...
    ylabels = ['Strongly disagree', 'Disagree', 'Somewhat disagree', 'Neither agree nor disagree', 'Somewhat agree', 'Agree', 'Strongly agree']      
    ylabels = [ '\n'.join(wrap(l, 10)) for l in ylabels ]
    ...
    make_barplot("Department_perception", desc, True, -3, 3, data_dict_ae1, ylabels, xlabels=['Q1', 'Q2', 'Q3', 'Q4', 'Q5'])
...
def ae2(include, desc, other_include = None):
    ...
    print("Questions AE2(SQ001)-AE2(SQ016) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
...
def ae21(include, desc, other_include=None):
    ...
    print("Questions AE21(SQ001)-AE21(SQ006) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
...
def ae3(include, desc, other_include = None):
    ...
    print("Questions AE3(SQ001)-AE3(SQ006) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
...
def ae4(include, desc, other_include = None):
    ...
    print("Questions AE4(SQ001)-AE4(SQ006) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
...
def ae5(include, desc, other_include = None):
    ...
    print("Questions AE5(SQ001)-A5(SQ005) are scored on a scale from 0-4 representing numerical values assigned to the possible answers.")
...
def mental_health_scores(include, desc, other_include = None):
    ...
    comp_mental_health_scores = [add(comp_asset_scores[i], comp_deficit_scores[i]) if var else None for i, var in enumerate(include_comp)]
